...
α = -0.2 # anharmonicity
dim = 101 # dimensionality of system
# Fit EC and EJ
fit_EC, fit_EJ = QSimulator.fit_fixed_transmon(f_01, α, dim)

# Verify that fit EC and EJ are consisent with f_01 and α
q0 = FixedTransmon("Test", fit_EC, fit_EJ, dim)
...
@test isapprox(f_01, f01_analytic; rtol=1e-3, atol=3e-3)
